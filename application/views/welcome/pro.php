...
<body style="background: #ebeaea;" class=" ext-webkit ext-chrome ext-mac">
					...
					<ul class="slides" style="width: 1000%; margin-left: -2560px;">
						<li class="clone" style="width: 1280px; float: left; display: block;">
							<div class="pro_one_nr">
								<img src="<?echo SITE_URL;?>/static/images/pro_02.jpg">
								<div class="pro1_one_main">
									<div class="container">
										<div class="pro1_one_main_con">
											...
											<p class="pro1_one2">
												烫发器、电吹风、理发器、个护系列四大主营品类。
											</p>
											<p class="sj_pro1_one1">
												所有造型产品外观设计时尚简约，色彩活力悦动。雷瓦工程师们从技术到生产工艺，注重每一处细节，精工细琢。<br> 同时充分考虑用户造型的需求及困难，注重产品实用功能化设计，使百变造型轻松简单，游刃有余。
											</p>
										</div>
									</div>
								</div>
	...
	<div class="pro1_two">
		...
		<div class="index_three_t" style="background: none;">
			<ul class="clearfix index_three_ul container">
				<li class="col-md-6 col-sm-6 col-xs-6">
					<a href="prolist/1/1">
						<img src="<?echo SITE_URL;?>/static/images/products_03.png">
				...
				<li class="col-md-6 col-sm-6 col-xs-6">
					<a href="prolist/2/1">
						<img src="<?echo SITE_URL;?>/static/images/products_05.png">
		...
		<div class="index_three_b" style="background: none;">
			<ul class="clearfix index_three_ul container">
				<li class="col-md-6 col-sm-6 col-xs-6">
					<a href="prolist/3/1">
						<img src="<?echo SITE_URL;?>/static/images/products_12.png">
				...
				<li class="col-md-6 col-sm-6 col-xs-6">
					<a href="prolist/4/1">
						<img src="<?echo SITE_URL;?>/static/images/products_10.png">
	...
	<div class="pro1_three">
		<img src="<?echo SITE_URL;?>/static/images/pro_06.jpg">
	...
	<ul class="container pro1_four clearfix">
		<li class="col-md-4 col-sm-4 col-xs-12">
			<div class="pro1_four_main">
				<img src="<?echo SITE_URL;?>/static/images/products_100.png">
			...
			<div class="pro1_four_main_b">
				<p>
					快速的生活节奏，做任何事都需要争分夺秒，造型也不例外。如何在有限的时间能做出适宜的个人造型，除了造型手法上的熟练外，实用易操作的造型产品必不可少。快速加热与散热、造型时间提醒、符合人体工学的造型手柄等都将是未来产品研发的方向。
				</p>
			</div>
		</li>
		<li class="col-md-4 col-sm-4 col-xs-12">
			<div class="pro1_four_main">
				<img src="<?echo SITE_URL;?>/static/images/products_07.png">
				<p class="pro1_four_main_name">
					可替换
				</p>
			</div>
			<div class="pro1_four_main_b">
				<p>
					对于当下潮男潮女而言，或多或少都有点选择恐惧症。单手柄搭配可替换的多种造型尺寸或满足多种造型需求的的配件，这样一款可以代替市面上大部分的造型产品，免去选择的麻烦及收纳的困难。
				</p>
			</div>
		</li>
		<li class="col-md-4 col-sm-4 col-xs-12">
			<div class="pro1_four_main">
				<img src="<?echo SITE_URL;?>/static/images/pro_07.png">
				<p class="pro1_four_main_name">
					易携带
				</p>
			</div>
			<div class="pro1_four_main_b">
				<p>
					造型产品将不仅限于家用，出差途中、度假旅行中、办公室、随身包、旅行箱等都将是造型产品未来出现的地点与场合。小巧迷你型、USB型、可折叠型、可替换型……方便易携带，让消费者能随身随地根据需要、根据心情变换造型。
				</p>
			</div>
		</li>
	</ul>
	<div class="pro1_five">
		...
		<a href="<?echo SITE_URL;?>mystyle" class="eng">
MORE
</a>
	</div>
