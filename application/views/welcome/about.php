...
<body style="background: #ebeaea;">
    ...
    <div class="about_tl">
        ...
        <div class="about_menu">
            <a href="about" class="ahover">品牌故事</a>
    ...
    <div class="about_ban">
        <img src="<?echo SITE_URL;?>/static/images/about_02.jpg">
    ...
    <div class="about1 container clearfix">
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_05.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_07.png">
        </div>
        <div class="left abou1_2">
            <img src="<?echo SITE_URL;?>/static/images/lw_03.png">
...
让每一位女性都可以轻松拥有美丽和时尚的渴望
        ...
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_09.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_11.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_12.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_17.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about-01_17-08.png">
        </div>
        <div class="left abou1_1">
            <img src="<?echo SITE_URL;?>/static/images/about1_21.png">
        </div>
    </div>
    <ul class="about_ul">
        <li class="clearfix container">
            <div class="col-md-7 col-sm-6 col-xs-12 about_ul_lf">
                <img src="<?echo SITE_URL;?>/static/images/about1_27.png">
            </div>
            <div class="col-md-5 col-sm-6 col-xs-12 about_ul_rt">
                <p class="about_ul_rttl_big">
                    2000年
                </p>
                <p class="about_ul_rt_big">游历欧美的刘友华先生</p>
                <p>机缘巧合发现国外女性由内而外散发出自信，迷人的光彩。</p>
                <p>深究后发现她们中的很多女性，注重个人形象和生活品质，</p>
                <p class="about_ul_rt_big">一个人能拥有多达3-4款甚至更多的造型产品。</p>
                <p>而这一切只为，每天以不同的形象，百变的造型，面对每个不同的场合。</p>
                <p>仅仅使用家用造型器，就能颠覆固有形象，</p>
        ...
        <li class="clearfix container about_ul_li2">
            <div class="col-md-7 col-sm-6 col-xs-12 about_ul_lf aboutt_lf">
                <img src="<?echo SITE_URL;?>/static/images/about1_31.png">
            </div>
        ...
        <li class="clearfix container">
            <div class="col-md-7 col-sm-6 col-xs-12 about_ul_lf">
                <img src="<?echo SITE_URL;?>/static/images/about1_34.png">
            </div>
            <div class="col-md-5 col-sm-6 col-xs-12 about_ul_rt">
                <p class="about_ul_rttl_big">
                    2009年
        ...
        <li class="clearfix container about_ul_li2">
            <div class="col-md-7 col-sm-6 col-xs-12 about_ul_lf aboutt_lf">
                <img src="<?echo SITE_URL;?>/static/images/about-01_38.png">
            </div>
            <div class="col-md-5 col-sm-6 col-xs-12 about_ul_rt aboutt_rt">
                <p class="about_ul_rttl_big">
                    2012年
    ...
    <div class="about2 container">
        <img src="<?echo SITE_URL;?>/static/images/about1_42.png">
    </div>
    <div class="about3 container">
        <p class="about3_1">
            RIWA 雷瓦，坚持创造这个美丽事业的初衷
        </p>
        <span class="about3_line"></span>
        <br> 为每一位用户，每一位女性带来轻松简单的美丽，
        <br> 主张“
        <span class="color_red">每个人都可以通过给自己造型的小改变，去大胆创造属于自己的美</span>”。
        <br>
        <br> 雷瓦，带来个人家用造型全新未来，
        <br> 为每一位追求美的人提供轻松愉悦、简单便捷、趣味横生的生活体验。
        <br>
        <br>
        <span class="rucimei">
美，如此简单
