...
<body style="background: #ebeaea;">
    ...
    <div class="about_tl">
        ...
        <div class="about_menu">
            <a href="about">品牌故事</a>
            <a href="about4" class="ahover">品牌印记</a>
            <a href="about2">品牌理念</a>
            <a href="about3">核心实力</a>
        </div>
    </div>
    <div class="about_ban">
        <img src="<?echo SITE_URL;?>/static/images/about4ban_02.jpg">
    ...
    <div class="container">
        <div class="about4_box img1">
            <div class="txt">WE HAVE BEEN MOVING</div>
            <div class="dot"><img src="<?echo SITE_URL;?>/static/images/about4/about4_01_dot.png" alt=""></div>
            <div class="year">201<em>6</em></div>
            <div class="histroy">RIWA雷瓦推出全新Everchanging百变造型器RC-7506，换“型”概念，开创美发造型新时代。</div>
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_01.jpg" alt="">
        </div>
        <div class="about4_box img2">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_02.jpg" alt="">
            <div class="year">201<em>6</em></div>
            <div class="histroy">世界知识产权组织（WPIO）认定RIWA（雷瓦） 为国际商标，在全球60个国家范围受到保护
            </div>
        </div>
        <div class="about4_box img3">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_03.jpg" alt="">
        ...
        <div class="about4_box img4">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_04.jpg" alt="">
            <div class="year">201<em>4</em></div>
            <div class="histroy">RIWA雷瓦荣获商派电商大会金商奖。</div>
        </div>
        <div class="about4_box img5">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_05.jpg" alt="">
            <div class="year">201<em>3</em></div>
            <div class="histroy">女士剃毛器RF-770A荣获中国设计红星奖及韩国好设计两项大奖。</div>
        </div>
        <div class="about4_box img6">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_06.jpg" alt="">
            <div class="year">201<em>2</em></div>
            <div class="histroy">RIWA雷瓦首次推出颠覆性的迷你型造型器RB-809S，使造型产品进入便携时代</div>
        </div>
        <div class="about4_box img7">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_07.jpg" alt="">
            <div class="year">201<em>2</em></div>
            <div class="histroy">成立上海雷瓦电器有限公司，正式进入中国市场。</div>
        </div>
        <div class="about4_box img8">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_08.jpg" alt="">
            <div class="year">201<em>0</em></div>
            <div class="histroy">研发的直发造型器在COSMOPROF亚太美容展上 大放异彩，获最受欢迎美发工具品牌荣誉。
            </div>
        </div>
        <div class="about4_box img9">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_09.jpg" alt="">
        ...
        <div class="about4_box img10">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_10.jpg" alt="">
            <div class="year start">2000</div>
        </div>
        <div class="about4_box img11">
            <img src="<?echo SITE_URL;?>/static/images/about4/about4_11.jpg" alt="">
        </div>
    </div>


    <div class="caitiao container">
        <img src="<?echo SITE_URL;?>/static/images/about1_46.png">
    </div>
