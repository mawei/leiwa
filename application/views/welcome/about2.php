...
<body style="background: #ebeaea;" class=" ext-webkit ext-chrome ext-mac">
    ...
    <div class="about_tl">
        ...
        <div class="about_menu">
            ...
            <a href="about2" class="ahover">品牌理念</a>
            <a href="about3">核心实力</a>
        </div>
    </div>
    <div class="about_ban">
        <img src="<?echo SITE_URL;?>/static/images/about2ban_02.jpg">
    ...
    <div class="ab2 container">
        <img src="<?echo SITE_URL;?>/static/images/about2_03.png">
        <div class="ab2_1 eng">
            <p>BEAUTY</p>
            IS EVERYWHERE
        </div>
        <div class="abt2_2">
            ...
            <p class="about_ul_rt_big">但是人们往往缺乏发现美的眼睛；</p>
            每个人都向往突破改变，但是经常无从下手。<br> 雷瓦倡导“
            <span class="about_ul_rt_big">造就美丽，从头开始</span>”的品牌理念，关注产品本身，回归研发设计的原点，
        </div>
    </div>
    <div class="ab3 container">
        <img src="<?echo SITE_URL;?>/static/images/about2bg_05.jpg">
        <div class="ab3_main">
            <p class="ab3_1 eng">
                JUST DISCOVER
            </p>
            <p class="ab3_2">美，不仅在于发现，更在于创造</p>
            <p class="yuandian">●</p>
            <p class="ab3_3">
                简洁实用的造型产品，让消费者从头开始，轻松地为自己造型，使造型过程变得简单而快捷，<br> 每个人都可以通过给自己造型的小改变，去大胆创造属于自己的美。
            </p>
        </div>
    </div>
    <div class="ab4 container">
        <img src="<?echo SITE_URL;?>/static/images/about2_07.png">
        <div class="ab4_1">
            <span class="ab4_1_1">
自由
</span>
            ...
            <p class="ab4_1_3">
                自由随性，张扬自我，在追寻自由与自我的过程中从未停歇过，表达自己的内心真实想法，追求简单轻松的生活状态，享受生活带来的愉悦。
            </p>
        </div>
        <div class="ab4_2">
            <span class="ab4_1_1">
