  <div class="footer">
        ...
        <div class="footer_2">
            <ul class="clearfix">
                <li>
                    <a href="<?=SITE_URL?>about">关于雷瓦</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>pro">造型产品</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>mystyle">我型我造</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>experience">贴心体验</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>news">雷瓦资讯</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>contactus">联系我们</a>
                </li>
                <li>
                    <a href="<?=SITE_URL?>#">官方商城</a>
                </li>
            </ul>
        </div>
        <div class="footer_3">
